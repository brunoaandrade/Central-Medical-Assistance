...
public class PAction implements Serializable{
	...
	private int period;   					// ex: 4 em 4 horas, seria period = 4
	private int numberreps;  				// numero de repeticoes, nao sei se será o numero de dias ou repeticoes efetivas, mas acho que se falou em dias
